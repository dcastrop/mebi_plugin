...
Proof. MeBiSim Begin compLTS p1 And compLTS p1 Using compLTS termLTS. 
...
Proof. MeBiSim Begin compLTS p1b And compLTS p1b Using compLTS termLTS. 
...
Proof. MeBiSim Begin compLTS p2 And compLTS p2 Using compLTS termLTS. 
  (* Iteration History: 2 <- _ <- _ <- _ *) 
  MeBiSim Solve 2.
Qed. *)
...
Proof. MeBiSim Begin compLTS p3a And compLTS p3b Using compLTS termLTS. 
  (* unfinished after 500000, crashed on 1000000. *)
  MeBiSim Solve 100000.
  (* MeBiSim Solve 100000. *)
  (* MeBiSim Solve 100000. *)
  (* MeBiSim Solve 100000. *)
  (* MeBiSim Solve 100000. *)
  (* MeBiSim Solve 100000. *)
  (* MeBiSim Solve 100000. Qed. *)
Admitted. *)
