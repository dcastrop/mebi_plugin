...
module ProofSolver : (_ : S) (_ : Encoding.SEncoding) -> sig
  val gl : Proofview.Goal.t ref
    ...
    module Model : sig
      ...
      module Annotations : sig
        module S : sig
          ...
          type t = Model.Make(M.Enc).Annotations.S.t
      ...
      module Transitions : sig
        module S : sig
          ...
          type t = Model.Make(M.Enc).Transitions.S.t
      ...
      module ActionMap : sig
        module M : sig
          type key = Action.t
          type 'a t = 'a Model.Make(M.Enc).ActionMap.M.t
      ...
      module EdgeMap : sig
        module M : sig
          type key = State.t
          type 'a t = 'a Model.Make(M.Enc).EdgeMap.M.t
      ...
      module Info : sig
        ...
        and bounds = Model.Make(M.Enc).Info.bounds =
          | States of int
          | Transitions of int
      ...
      module Saturate : sig
        type data = Model.Make(M.Enc).Saturate.data =
        ...
        and wip = Model.Make(M.Enc).Saturate.wip =
          { from : State.t
          ; via : Label.t
          ; trees : Trees.t
          }
      ...
      module Bisimilar : sig
        ...
        and result = Model.Make(M.Enc).Bisimilar.result =
          { bisim_states : Partition.t
          ; non_bisim_states : Partition.t
          }

        and fsm_pair = Model.Make(M.Enc).Bisimilar.fsm_pair =
          { original : FSM.t
          ; saturated : FSM.t
          }
  ...
  module Tacs : sig
    val inversion : Rocq_utils.hyp -> Tactic.t M.mm
    val subst_all : unit -> Tactic.t M.mm
    val simplify_concl : unit -> Tactic.t M.mm
    val simplify_hyp : Rocq_utils.hyp -> Tactic.t M.mm
    val simplify_hyps : unit -> Tactic.t M.mm
    val simplify_all : unit -> Tactic.t M.mm
    val simplify_and_subst_all : unit -> Tactic.t M.mm
    val cofix : unit -> Tactic.t M.mm
    val intros_all : unit -> Tactic.t M.mm
    val intro_as : string -> Tactic.t M.mm
    val apply : Evd.econstr -> Tactic.t M.mm
    val eapply : Evd.econstr -> Tactic.t M.mm

    exception CannotUnfoldConstr of Constr.t

    val unfold_constr : ?in_hyp:Rocq_utils.hyp -> Constr.t -> Tactic.t M.mm
    val unfold_econstr : ?in_hyp:Rocq_utils.hyp -> Evd.econstr -> Tactic.t M.mm
  ...
  module Theory : sig
    val apply_Pack_sim : unit -> Tactic.t M.mm
    val apply_In_sim : unit -> Tactic.t M.mm
    val apply_wk_some : unit -> Tactic.t M.mm
    val apply_wk_none : unit -> Tactic.t M.mm
    val apply_rt1n_refl : unit -> Tactic.t M.mm
    val apply_rt1n_trans : unit -> Tactic.t M.mm
    val eapply_rt1n_refl : unit -> Tactic.t M.mm
    val eapply_rt1n_trans : unit -> Tactic.t M.mm
    val unfold_silent : unit -> Tactic.t M.mm
    val unfold_silent1 : unit -> Tactic.t M.mm
    ...
    val is_fsm_silent_label : Evd.econstr -> Model.FSM.t -> bool M.mm

    exception FSM_HasNoVisibleLabel of Model.FSM.t

    val is_fsm_visible_label : Evd.econstr -> Model.FSM.t -> bool M.mm

    exception FSM_HasNoWeakLabels of Model.FSM.t

    val is_fsm_weak_labels : Evd.econstr -> Model.FSM.t -> bool M.mm

    exception FSM_HasNoConstructors of Model.FSM.t

    val is_fsm_constructor : Evd.econstr -> Model.FSM.t -> bool M.mm
  end

  module ReModel : sig
    exception CouldNotFind_State of (Evd.econstr * Model.Partition.elt)

    val state : Evd.econstr -> Model.Partition.elt -> Model.State.t M.mm

    exception CouldNotFind_Label of (Evd.econstr * Model.Labels.t)

    val label : Evd.econstr -> Model.Labels.t -> Model.Label.t M.mm
  end
  ...
  module Trans : sig
    module Make : (X : sig
      ...
      val fill : ?label:X.label -> ?goto:X.state -> partial -> t M.mm
    end
    ...
    module RocqTrans : sig
      ...
      exception LabelArgNotEqExisting of (Evd.econstr * partial)
      exception GotoArgNotEqExisting of (Evd.econstr * partial)
      exception ArgsFillNothing of unit

      val fill : ?label:Evd.econstr -> ?goto:Evd.econstr -> partial -> t M.mm
    end
    ...
    module EncTrans : sig
      ...
      val fill : ?label:M.Enc.t -> ?goto:M.Enc.t -> partial -> t M.mm
    end
    ...
    module ModelTrans : sig
      ...
      exception LabelArgNotEqExisting of (Model.Label.t * partial)
      exception GotoArgNotEqExisting of (Model.State.t * partial)
      exception ArgsFillNothing of unit
