...
module Make : (Log : Logger.SLogger)
  ...
  module W : sig
    module M : sig
      ...
      val make_set :
        unit -> (module Set.S with type elt = Enc.t)
    ...
    module Model : sig
      ...
      module States : sig
        module S : sig
          ...
          type t =
            Model.Make(Log)(M.Enc).States.S.t
      ...
      module Labels : sig
        module S : sig
          ...
          type t =
            Model.Make(Log)(M.Enc).Labels.S.t
      ...
      module Actions : sig
        module S : sig
          ...
          type t =
            Model.Make(Log)(M.Enc).Actions.S.t
    ...
    module Graph : (T0 : sig
      ...
      module Make : (_ : Y_Args) -> sig
        ...
        val get_new_constrs :
          T.key -> M.Constructor.t list M.mm
      ...
      val make_zargs :
        M.Ind.t M.B.t -> t ref -> (module Z_Args)
    ...
    module Decode : sig
      ...
      exception
        CouldNotDecode_LTS_Constructor of Model.Info.lts
  ...
  module Transition : sig
    ...
    type t = { hyp : Model.Transition.t; goal : Opt.t }
  end
  ...
  type state = { p : Declare.Proof.t; x : State.t }
  ...
  module P : (_ : sig
    ...
    module Tacs : sig
      ...
      val apply : Evd.econstr -> Tactic.t mm
      ...
      val eapply : Evd.econstr -> Tactic.t mm
      ...
      val unfold_constr :
        ?in_hyp:Rocq_utils.hyp -> Constr.t -> Tactic.t mm

      val unfold_econstr :
        ?in_hyp:Rocq_utils.hyp -> Evd.econstr -> Tactic.t mm
    ...
    module Theory : sig
      val is_theory : Evd.econstr -> Evd.econstr -> bool mm
      val is_exists : Evd.econstr -> bool mm
      val is_weak_sim : Evd.econstr -> bool mm
      val is_weak : Evd.econstr -> bool mm
      val is_tau : Evd.econstr -> bool mm
      val is_silent : Evd.econstr -> bool mm
      val is_silent1 : Evd.econstr -> bool mm
      val is_LTS : Evd.econstr -> bool mm
      val is_None : Evd.econstr -> bool mm
      val is_Some : Evd.econstr -> bool mm

      val get_theory_enc :
        (Evd.econstr -> bool mm) -> M.Enc.t M.mm
      ...
      val get_theory_enc_if_eq :
        Evd.econstr -> (Evd.econstr -> bool mm) -> M.Enc.t M.mm
    ...
    module ReModel : sig
      exception
        CouldNotFind_State of (Evd.econstr * Model.States.t)

      val state :
        Evd.econstr -> Model.States.t -> Model.State.t M.mm
