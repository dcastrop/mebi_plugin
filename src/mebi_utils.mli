...
module Strfy : sig
  ...
  val feconstr_rel_decl : EConstr.rel_declaration Utils.Strfy.to_string
end
...
val get_name_of_lts : Names.GlobRef.t -> Evd.econstr Mebi_wrapper.mm
...
val econstr_to_constr_opt : Evd.econstr -> Constr.t option Mebi_wrapper.mm

val constrexpr_to_econstr
  :  Constrexpr.constr_expr
  -> Evd.econstr Mebi_wrapper.mm

val globref_to_econstr : Names.GlobRef.t -> Evd.econstr Mebi_wrapper.mm
val type_of_econstr : Evd.econstr -> Evd.econstr Mebi_wrapper.mm
val type_of_constrexpr : Constrexpr.constr_expr -> Evd.econstr Mebi_wrapper.mm
...
val try_get_none_enc_opt : Evd.econstr -> Mebi_setup.Enc.t option
val try_get_some_enc_opt : Evd.econstr -> Mebi_setup.Enc.t option
val encode_econstr : Evd.econstr -> Mebi_setup.Enc.t Mebi_wrapper.mm
