...
type filename_kind = Auto of unit | Just of string
...
val write_json_extra_to_file :
  out_channel -> Utils.model_info option -> unit

val write_json_info_to_file : out_channel -> model_info -> unit

val write_json_alphabet_to_file :
  out_channel -> json_action Queue.t -> unit

val write_xl_string_to_file : out_channel -> string -> unit

val write_json_states_to_file :
  out_channel -> json_state Queue.t -> unit

val write_json_edges_to_file :
  out_channel -> json_edge Queue.t -> unit
