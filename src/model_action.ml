...
let is_silent (a : t) : bool =
  match a.is_silent with None -> raise (ActionSilenceIsNone a) | Some b -> b
;;

let has_label (l : Model_label.t) (a : t) : bool = Model_label.eq l a.label

let to_label_meta_pair (a : t) : Model_label.t * Model_label.meta =
  a.label, { is_silent = a.is_silent; info = a.info }
;;
