type unif_problem = { termL : EConstr.t; termR : EConstr.t }
...
module Enc : sig
  module F : sig
    ...
    type 'a t =
      'a Rocq_enc.Make(Rocq_enc.IntEncoding(FwdMap)).F.t
  ...
  type t = Rocq_enc.Make(Rocq_enc.IntEncoding(FwdMap)).t
  ...
  module B : sig
    ...
    type 'a t =
      'a Rocq_enc.Make(Rocq_enc.IntEncoding(FwdMap)).B.t
