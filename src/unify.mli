...
val debug_mebiconstrs : string -> Mebi_constr.t list -> unit Mebi_wrapper.mm
...
val unify : ?debug:bool -> unification_pair -> bool Mebi_wrapper.mm
...
val sandbox_unify_all_opt
  ...
  -> Evd.econstr
  -> unification_problem list
  -> (Evd.econstr * Mebi_constr.Tree.t list) option Mebi_wrapper.mm
...
val debug_substl : string -> EConstr.Vars.substl -> unit Mebi_wrapper.mm
...
val debug_decls : string -> Rocq_utils.econstr_decls -> unit Mebi_wrapper.mm
...
exception ConstructorNameNotRecognized of (Evd.econstr * Evd.econstr)
...
val get_ind_constrs_opt
  :  Evd.econstr
  -> data
  -> ((int * Rocq_utils.ind_constrs) option * Evd.econstr array) option
       Mebi_wrapper.mm
...
val debug_validconstrs_begin : Rocq_utils.ind_constrs -> unit Mebi_wrapper.mm
...
val debug_updatesigma_none : Evd.econstr -> unit Mebi_wrapper.mm
val debug_updatesigma_some_args : Evd.econstr array -> unit Mebi_wrapper.mm
val debug_updatesigma_some_pair : Evd.econstr array -> unit Mebi_wrapper.mm
