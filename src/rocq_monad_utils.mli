module Make : (Log : Logger.S)
  ...
  include module type of Rocq_monad.Make (Log) (C) (E)
  ...
  val exists_eq :
    Evd.econstr -> 'a list -> ('a -> Evd.econstr) -> bool
  ...
  module Strfy : sig
    ...
    val econstr_bindings :
      Evd.econstr Tactypes.bindings -> string
  end
  ...
  module Ind : sig
    ...
    val assert_mip_arity_is_type_or_set :
      Declarations.one_inductive_body -> unit mm
  ...
  module Constructor_ : module type of Enc_constructor_tree.Make (Log) (Enc)
  module Tree = Constructor_.Tree

    module Constructor : sig
            include module type of Constructor_.Constructor
