module Make : (Log : Logger.SLogger)
  ...
  module Graph : (T0 : sig
    ...
    module Make : (_ : Y_Args) -> sig
      ...
      val get_new_states : V.elt -> M.Constructor.t list -> V.t M.mm
    ...
    val find_primary_lts : V0.elt Rocq_ind.t M.B.t -> V0.elt Rocq_ind.t M.mm
    ...
    val make_zargs : V0.elt Rocq_ind.t M.B.t -> t ref -> (module Z_Args)
