module Make : (Log : Logger.S)
  ...
  module TreeNode: module type of Tree_.Node
  module Tree : module type of Tree_.Tree
  module Trees : module type of Tree_.Trees (Tree)

  module State_ : module type of Model_state.Make (Log) (Enc)
  module State : State_.S
  module States : module type of State_.States (State)

  module Label_ : module type of Model_label.Make (Log) (Enc)
  module Label : Label_.S
  module Labels : module type of Label_.Labels (Label)


  module Annotation_ : module type of Model_annotation.Make (Log) (Enc) (State) (Label) (Tree_) (Tree)
  module Note : module type of Annotation_.Note
  module Annotation : Annotation_.S
  module Annotations : module type of Annotation_.Annotations (Annotation)


  module Transition_ :module type of
    Model_transition.Make (Log) (Enc) (State) (Label_) (Labels) (Tree_)
      (Annotation)

  module Transition : Transition_.S
  module Transitions : module type of Transition_.Transitions (Transition)
