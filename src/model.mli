...
exception
  CouldNotFindActionWithMatchingLabel of
    (Action.Label.t * States.t Actions.t)

val get_action_with_label :
  States.t Actions.t -> Action.Label.t -> Action.t
...
val get_destinations_of_label :
  Action.Label.t -> States.t Actions.t -> States.t
