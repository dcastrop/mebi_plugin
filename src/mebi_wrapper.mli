...
module type ERROR_TYPE = sig
  type mebi_error =
    ...
    | Invalid_KindOfTypeEConstr_Expected_Sort of
        (Mebi_setup.coq_context ref * EConstr.t)
    | UnknownEncodeKey of (Mebi_setup.coq_context ref * Enc.t F.t * EConstr.t)
...
val invalid_kind_of_econstr_expected_atomic : EConstr.t -> 'a mm
val invalid_kind_of_econstr_expected_cast : EConstr.t -> 'a mm
val invalid_kind_of_econstr_expected_letin : EConstr.t -> 'a mm
val invalid_kind_of_econstr_expected_prod : EConstr.t -> 'a mm
val invalid_kind_of_econstr_expected_sort : EConstr.t -> 'a mm
...
val invalid_sort_lts : Sorts.Quality.t -> 'a mm
val invalid_sort_type : Sorts.Quality.t -> 'a mm
...
val encoding : EConstr.t -> Enc.t mm
val has_encoding : EConstr.t -> bool
val get_encoding : EConstr.t -> Enc.t
val encoding_opt : EConstr.t -> Enc.t option mm
val get_encoding_opt : EConstr.t -> Enc.t option
val decode : Enc.t -> EConstr.t mm
val decoding : Enc.t -> EConstr.t mm
val has_decoding : Enc.t -> bool
val get_decoding : Enc.t -> EConstr.t
val decode_opt : Enc.t -> EConstr.t option mm
val get_decode_opt : Enc.t -> EConstr.t option
